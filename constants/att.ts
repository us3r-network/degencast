...
export const UNISWAP_V3_QUOTER_CONTRACT_ADDRESS =
  process.env.EXPO_PUBLIC_UNISWAP_V3_QUOTER_V2_CONTRACT_ADDRESS;
export const UNISWAP_V3_POOL_CONTRACT_ADDRESS =
  process.env.EXPO_PUBLIC_UNISWAP_V3_FACTORY_CONTRACT_ADDRESS;
export const UNISWAP_V3_SWAP_ROUTER_CONTRACT_ADDRESS =
  process.env.EXPO_PUBLIC_UNISWAP_V3_SWAP_ROUTER_02_CONTRACT_ADDRESS;
