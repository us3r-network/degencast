  ...
  (
    ...
    return (
      <View className="flex gap-4">
        ...
        <View className="flex-row items-center justify-between">
          <View>
            <Text className="font-interBold text-lg">Quantity</Text>
        ...
        <View className="flex-row items-center justify-between">
          <Text className="font-interBold text-lg">Receive:</Text>
          {price && amount && token && token.decimals ? (
  ...
  (
    ...
    return (
      <View className="flex gap-4">
        ...
        <View className="flex-row items-center justify-between">
          <Text className="font-interBold text-lg">Total Cost</Text>
          {fetchedPrice ? (
            <Text>
              {formatUnits(price, token.decimals!)} {token.symbol}
            </Text>
