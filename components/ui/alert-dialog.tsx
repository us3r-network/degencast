    ...
    <AlertDialogPortal>
      <AlertDialogOverlay>
        <AlertDialogPrimitive.Content
          ref={ref}
          className={cn(
            "z-50 max-w-lg gap-4 rounded-lg bg-background p-6 shadow-lg shadow-foreground/10 web:duration-200",
            open
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn(
      "native:text-xl font-interSemiBold text-lg text-foreground",
      className,
    )}
    {...props}
  />
